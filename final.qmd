...
![REMS being installed on Curiosity prior to launch. Credit: NASA/JPL-Caltech](rems_jpl_build.jpg){width=70% fig-align="center"}
...
![REMS sensors on Curiosity on the surface of Mars. Credit: NASA](rems_mars.jpg){width=70% fig-align="center"}
...
::: {layout-nrow=2}
![Early traverse tab: static ggplot on local Gale Crater coordinates](og_traverse.png){fig-align="center" width=50%}

![Early pressure tab: LOESS smooth was active at this stage and it looks... bad](og_pressure.png){fig-align="center"}
:::
